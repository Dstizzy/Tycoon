...
public class HoverScript : MonoBehaviour {
    //// You can use Vector2 for mouse position in 2D to simplify the physics call
    //RaycastHit2D raycastHit2D;

    //// We only need two variables for state comparison
    ...
    //        currentHoverObject.GetComponent<SpriteRenderer>().color = Color.red;
    //    }
